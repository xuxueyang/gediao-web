<template>
    <div>
        <h2 style="margin-bottom:50px;font-family:'STXingkai'">天涯明月刀</h2>
...
export default {
    ...
    methods:{
      transferToXSRM(){
        window.open("https://pay.qq.com/")
      },
      transferToXBB() {
        window.open("http://wuxia.qq.com/act/a20160423station/camp.shtml?ADTAG=media.buy.sogoukeyword.fppc_td_100016")
      },
      transferToFBGL() {
        window.open("http://wuxia.qq.com/act/a20160423station/camp.shtml?ADTAG=media.buy.sogoukeyword.fppc_td_100016")
      },
