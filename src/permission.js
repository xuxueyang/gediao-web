...
const whiteList = ['/login', '/regestry', '/home', '/404', '/401', '/400', '/', '/manager', '/tiandao', '/nishuihan', '/gediao', '/gediao/detail', '/qlh', '/effects', '/gediao/blog', '/blog','/blog/:id','/blogCategorys'] // 不重定向白名单
